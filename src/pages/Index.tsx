      ...
      <div className="max-w-4xl mx-auto text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-12">
          ...
          animationDelay: "0.2s"
            ...
            <div className="h-12 w-12 bg-gradient-to-br from-tutor-primary to-tutor-secondary rounded-xl mb-6 mx-auto flex items-center justify-center bg-zinc-950 hover:bg-zinc-800">
