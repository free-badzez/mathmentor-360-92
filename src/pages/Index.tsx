      ...
      <div className="max-w-4xl mx-auto text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-12">
          ...
          animationDelay: "0.2s"
            ...
            <div className="h-12 w-12 bg-gradient-to-br from-tutor-primary to-tutor-secondary rounded-xl mb-6 mx-auto flex items-center justify-center bg-neutral-900 hover:bg-neutral-800">
          ...
          animationDelay: "0.3s"
            ...
            <div className="h-12 w-12 bg-gradient-to-br from-tutor-secondary to-tutor-accent rounded-xl mb-6 mx-auto flex items-center justify-center bg-neutral-800 hover:bg-neutral-700">
              <svg className="w-6 h-6 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        animationDelay: "0.4s"
          ...
          <button className="bg-gradient-to-r from-tutor-primary to-tutor-secondary text-white px-8 py-3 rounded-xl font-medium hover:shadow-lg premium-transition bg-[#54c1ef]">
            Get Started
          </button>
        </div>
      </div>
