...
const Formulas = () => {
  ...
  const formulas = {
    algebra: [
      ...
      { name: "Sum of Cubes", formula: "a³ + b³ = (a + b)(a² - ab + b²)", explanation: "Used to factor the sum of cubes", example: "x³ + 8 = (x + 2)(x² - 2x + 4)" },
      { name: "Difference of Cubes", formula: "a³ - b³ = (a - b)(a² + ab + b²)", explanation: "Used to factor the difference of cubes", example: "x³ - 8 = (x - 2)(x² + 2x + 4)" },
      { name: "Perfect Square Trinomial", formula: "a² + 2ab + b² = (a + b)²", explanation: "Used to factor perfect square trinomials", example: "x² + 6x + 9 = (x + 3)²" },
    ],
    trigonometry: [
      ...
      { name: "Double Angle Formulas", formula: "sin(2θ) = 2sin(θ)cos(θ)\ncos(2θ) = cos²(θ) - sin²(θ)", explanation: "Used to find trig values of double angles", example: "sin(60°) = 2sin(30°)cos(30°) = 2(0.5)(0.866) = 0.866" },
      { name: "Half Angle Formulas", formula: "sin²(θ/2) = (1 - cos(θ))/2\ncos²(θ/2) = (1 + cos(θ))/2", explanation: "Used to find trig values of half angles", example: "sin²(45°) = (1 - cos(90°))/2 = 0.5" },
      { name: "Sum and Difference Formulas", formula: "sin(A ± B) = sin(A)cos(B) ± cos(A)sin(B)", explanation: "Used to find trig values of sum or difference of angles", example: "sin(75°) = sin(45° + 30°) = sin(45°)cos(30°) + cos(45°)sin(30°)" },
    ],
    polynomial: [
      ...
      { name: "Remainder Theorem", formula: "If P(x) ÷ (x - a) = Q(x) + R, then R = P(a)", explanation: "The remainder when dividing by (x - a) equals P(a)", example: "For P(x) = x³ - 6x² + 11x - 6, P(1) gives remainder when divided by (x - 1)" },
      { name: "Rational Root Theorem", formula: "Possible rational roots = ±(factors of constant term)/(factors of leading coefficient)", explanation: "Used to find potential rational roots of a polynomial", example: "For x³ - 6x² + 11x - 6, possible roots are factors of 6: ±1, ±2, ±3, ±6" },
    ],
    geometry: [
      ...
      { name: "Regular Polygon", formula: "Area = (n × s × h)/2\nPerimeter = n × s", explanation: "n = number of sides, s = side length, h = apothem", example: "For a regular hexagon with side 4 and apothem 3.46:\nArea = (6 × 4 × 3.46)/2 = 41.52" },
      { name: "Sphere", formula: "Surface Area = 4πr²\nVolume = (4/3)πr³", explanation: "r is the radius of the sphere", example: "For a sphere with radius 3:\nSurface Area = 4π(3²) = 113.1\nVolume = (4/3)π(3³) = 113.1" },
      { name: "Cylinder", formula: "Surface Area = 2πr² + 2πrh\nVolume = πr²h", explanation: "r is radius, h is height", example: "For a cylinder with radius 2 and height 5:\nVolume = π(2²)(5) = 62.8" },
    ],
    calculus: [
      ...
      { name: "Partial Fractions", formula: "∫[P(x)/Q(x)]dx where deg(P) < deg(Q)", explanation: "Used to integrate rational functions", example: "∫[1/(x²-1)]dx = ½ln|x-1| - ½ln|x+1| + C" },
      { name: "L'Hôpital's Rule", formula: "lim(x→a) f(x)/g(x) = lim(x→a) f'(x)/g'(x)", explanation: "Used when limit gives 0/0 or ∞/∞", example: "lim(x→0) sin(x)/x = lim(x→0) cos(x)/1 = 1" },
    ],
  };
