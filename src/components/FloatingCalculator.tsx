  ...
  return (
    <div className="fixed bottom-4 right-4 z-50">
      <Button
        variant="outline"
        size="icon"
        className="rounded-full bg-tutor-primary text-white hover:bg-tutor-secondary"
      ...
      {isOpen && (
        <Card className="absolute bottom-16 right-0 w-64 p-4 glass-card animate-fade-up shadow-xl">
