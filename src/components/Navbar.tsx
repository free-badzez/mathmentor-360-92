...
const Navbar = () => {
  ...
  return <nav className="fixed top-0 left-0 right-0 glass-nav z-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16">
          <div className="flex">
            <Link to="/" className="flex items-center px-4 text-foreground hover:text-foreground/90 premium-transition">
...
const NavLink = ({
  ...
  text: string;
  isActive: boolean;
}) => <Link to={to} className={`flex items-center px-4 py-2 rounded-xl text-sm font-medium transition-colors ${isActive ? "bg-accent text-accent-foreground" : "text-foreground/70 hover:text-foreground hover:bg-accent/50"} premium-transition group`}>
    {icon}
...
const MobileNavLink = ({
  ...
  text: string;
  isActive: boolean;
}) => <Link to={to} className={`flex items-center px-4 py-2 rounded-xl text-sm font-medium transition-colors ${isActive ? "bg-accent text-accent-foreground" : "text-foreground/70 hover:text-foreground hover:bg-accent/50"} premium-transition`}>
    {icon}
